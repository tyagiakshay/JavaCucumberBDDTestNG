...
public class BrowserUtility {
	public static WebDriver OpenBrowser(WebDriver driver, String browserName) throws InterruptedException {
		String DriversDir = System.getProperty("user.dir") + "/resources/Drivers/";
...
//			driver.get(url);
			...
			System.setProperty("webdriver.ie.driver",
					DriversDir+"InterExplorerDriver.exe");
